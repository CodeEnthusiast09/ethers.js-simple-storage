...
export interface Contracts_extraStorage_sol_ExtraStorageInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "addPerson"
...
export interface Contracts_extraStorage_sol_ExtraStorage extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): Contracts_extraStorage_sol_ExtraStorage;
  waitForDeployment(): Promise<this>;

  interface: Contracts_extraStorage_sol_ExtraStorageInterface;
