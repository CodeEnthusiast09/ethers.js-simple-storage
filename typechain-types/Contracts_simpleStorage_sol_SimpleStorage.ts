...
export interface Contracts_simpleStorage_sol_SimpleStorageInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "addPerson"
...
export interface Contracts_simpleStorage_sol_SimpleStorage
  ...
  interface: Contracts_simpleStorage_sol_SimpleStorageInterface;
